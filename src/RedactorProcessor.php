...
final class RedactorProcessor implements ProcessorInterface
{
    ...
    public function setMaxItemsPerContainer(?int $count): void
    {
    ...
    public function setMaxTotalNodes(?int $count): void
    {
        if (null !== $count && $count < 0) {
    ...
    public function setOnLimitExceededCallback(?callable $cb): void
    {
        $this->onLimitExceededCallback = $cb;
    }
    ...
    public function setOverflowPlaceholder(mixed $value): void
    {
